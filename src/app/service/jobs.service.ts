...
import { Job } from '../components/model/jobs';
...
export class JobsService {
  ...
  public detail(id: number):Observable<Job> {
    return this.http.get<Job>(this.apiUrl + 'detail/${id}')
  } 
  ...
  public saveJob(Job: Job): Observable<any> {
    return this.http.post<any>(this.apiUrl + 'new', Job);
  }
